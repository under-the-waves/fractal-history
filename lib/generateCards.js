...
async function genSection(anchor, { topic, context, heading, subject, guidance, coverageRule, titleRule, cardCountRule, evidence }, model) {
...
export async function generateCards(anchor, children, research, frame = null, model = CARDS_MODEL) {
    ...
    const allFacts = [...(prelude?.facts || []), ...subAnchors.flatMap(sa => sa.facts)];
