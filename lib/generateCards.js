...
async function genSection(anchor, { topic, context, heading, subject, guidance, coverageRule, titleRule, evidence }, model) {
...
export async function generateCards(anchor, children, research, frame = null, model = CARDS_MODEL) {
    ...
    const prelude = preludeRes && preludeRes.facts.length
        ? { title: preludeRes.title || `Before this: the world before ${topic}`, facts: preludeRes.facts }
        : null;
